...
export default async function AbaProviderAdminDashboardPage() {
  ...
  return (
    <PageContainer title="ABA Provider Dashboard" description="Referral status and diagnostic updates">
